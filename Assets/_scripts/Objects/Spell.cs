...
public class Spell
{
    ...
    public int time; // 1 - действие, 2 - реакция, 3 - 1 час, 4 - бонусное, 5 - 1 минута
                     // 6 - 10 мин, 7 - 12 часов, 8 - 8 часов, 9 - 24 часа
    public string reactionDis;
    public int dist; // -1 - на себя, 0 - касание, -2 - особая, -3 - в пределах видимости, -4 - 1 миля, -5 - неограниченая, -6 - 500 миль
    ...
    public int duration; // 1 - мгновенное, 2 - 1 раунд, 3 - 1 минута, 
                         ...
                         // 9 - пока не рассеется, 10 - 2 часа, 11 - 7 дней, 12 - пока не рассеется или не сработает
                         // 13 - 30 дней, 14 - особая, 15 - 6 раундов
